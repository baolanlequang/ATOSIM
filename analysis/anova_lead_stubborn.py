"""
F-ANOVA Pipeline: Lead Stubborn Mining Simulation
============================================
...
fig.suptitle("F-ANOVA Pipeline — Lead Stubborn Mining (DoubleSpendSuccessProbability)",
...
plt.savefig("./figures/anova_lead_stubborn_results.png",
            dpi=150, bbox_inches="tight", facecolor="white")
print("  Đã lưu biểu đồ: anova_lead_stubborn_results.png")
print()
print("=" * 60)
