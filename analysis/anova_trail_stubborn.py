"""
F-ANOVA Pipeline: Trail Stubborn Mining Simulation
============================================
...
fig.suptitle("F-ANOVA Pipeline — Trail Stubborn Mining (DoubleSpendSuccessProbability)",
...
plt.savefig("./figures/anova_trail_stubborn_results.png",
            dpi=150, bbox_inches="tight", facecolor="white")
print("  Đã lưu biểu đồ: anova_trail_stubborn_results.png")
print()
print("=" * 60)
