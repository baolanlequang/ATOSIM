...
# 1. LOAD DATA
# ─────────────────────────────────────────────
JSON_FOLDER = "../results/selfish_trail_stubborn"
...
fig.suptitle("F-ANOVA Pipeline — Selfish + Trail Stubborn Mining (DoubleSpendSuccessProbability)",
...
plt.savefig("./figures/anova_selfish_trail_stubborn_results.png",
            dpi=150, bbox_inches="tight", facecolor="white")
print("  Đã lưu biểu đồ: anova_selfish_trail_stubborn_results.png")
print()
print("=" * 60)
