...
public class BlockSentTraceEvent implements TraceEvent {
    ...
    public BlockSentTraceEvent(long occurrenceTime, Block sentBlock, P2PNetworkEndpoint receivingNetworkEndpoint) {
