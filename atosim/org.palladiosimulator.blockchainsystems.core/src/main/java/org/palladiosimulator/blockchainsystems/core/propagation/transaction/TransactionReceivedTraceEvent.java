...
public class TransactionReceivedTraceEvent implements TraceEvent {
    ...
    public TransactionReceivedTraceEvent(long occurrenceTime, Transaction sentTransaction, P2PNetworkEndpoint receivingNetworkEndpoint) {
