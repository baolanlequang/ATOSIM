...
# run_selfish.sh` runs, covering the full 500,000-row CSV at ROWS_PER_TASK=500.
# To use a different ROWS_PER_TASK, or to stay under a cluster MaxArraySize
# below 1000, submit via:
#   ./submit_chunked_array.sh run_selfish.sh 500000 [chunk_size] [sleep_between] [start_offset] [rows_per_task]
